	...
	<body>
		...
		<div id="all">
			...
			<div id="bottom">
				...
				<div id="bleft">
					<div id="ltop">
						<div id="lts">
							...
							<p style="text-align: center;">系统管理员</p>
						</div>
					</div>
					<div id="lbottom">
						<ul>
							<a href="${pageContext.request.contextPath}/product/splitpage.action" target="myright" >
				...
				<!--下部分右边-->
				<div id="bright">
					<iframe frameborder="0" scrolling="yes" name="myright" width="1235px" height="700px" ></iframe><!--表示可以滚动-->
				</div>
			</div>
		</div>
	</body>
