...
<html>
        ...
        function fileChange(){//注意：此处不能使用jQuery中的change事件，因此仅触发一次，因此使用标签的：onchange属性
           alert("change");
            $.ajaxFileUpload({
                ...
                success: function(obj) //服务器成功响应处理函数，obj是服务器端上传回来的对象
                {
                	alert(obj);
                    $("#imgDiv").empty();  //清空原有数据
                    //创建img 标签对象
	...
	<!--取出上一个页面上带来的page的值-->
		...
		<div id="addAll">
			...
			<div id="table">
				<form action="${pageContext.request.contextPath}/product/addproduct.action" enctype="multipart/form-data"
							...
							<td>
								...
								<script type="text/javascript">
									function myclose(ispage) {
										window.location="${pageContext.request.contextPath}/product/splitpage.action?page="+ispage;
									}
								</script>
							</td>
						</tr>
